...
- **سرور ایران = Client**  
- **سرور آلمان = Server**  
به‌طوری‌که تمام ترافیک سرور ایران از طریق سرور آلمان عبور کند.
...
2. روی سرور آلمان گزینه **2 (Server)** را بزنید.
...
- آدرس‌های تونل:
  - Server (آلمان): `10.0.0.1/24`
  - Client (ایران): `10.0.0.2/24`
- روی سرور آلمان: `IP Forwarding` به‌صورت پایدار فعال می‌شود و `MASQUERADE` روی اینترفیس اینترنتی تنظیم می‌گردد.
